...
public class IPresenter extends BasePresenter<Contract.IMainView> implements Contract.IPresenter {
    ...
    @Override
    public void collection(Map<String, Object> headerMap, Map<String, Object> queryMap) {
        iModel.collection ( headerMap, queryMap, new Contract.IModel.CollectionCallBack () {
            @Override
            public void backData(CollectionBean collectionBean) {
