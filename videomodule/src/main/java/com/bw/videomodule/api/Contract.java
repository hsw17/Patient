...
public interface Contract {
    ...
    interface IModel{
        ...
        void collection(Map<String, Object> headerMap,Map<String, Object> queryMap,CollectionCallBack callBack);
        ...
        interface CollectionCallBack{
            void backData(CollectionBean collectionBean);
            void fuilerror(String e);
        }
    }
    ...
    interface IPresenter{
        ...
        void collection(Map<String, Object> headerMap,Map<String, Object> queryMap);
