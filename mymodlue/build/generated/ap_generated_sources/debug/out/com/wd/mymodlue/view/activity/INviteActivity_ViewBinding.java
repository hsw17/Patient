...
public class INviteActivity_ViewBinding implements Unbinder {
  ...
  public INviteActivity_ViewBinding(INviteActivity target, View source) {
    ...
    target.inviteEditCode = Utils.findRequiredViewAsType(source, R.id.invite_edit_code, "field 'inviteEditCode'", TextView.class);
    ...
    target.inviteSimplView = Utils.findRequiredViewAsType(source, R.id.invite_simpl_view, "field 'inviteSimplView'", ImageView.class);
    ...
    target.inviteTextCode = Utils.findRequiredViewAsType(source, R.id.invite_text_code, "field 'inviteTextCode'", TextView.class);
  }
