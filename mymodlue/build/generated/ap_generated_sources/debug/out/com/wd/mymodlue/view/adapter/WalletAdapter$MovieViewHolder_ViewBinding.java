...
public class WalletAdapter$MovieViewHolder_ViewBinding implements Unbinder {
  private WalletAdapter.MovieViewHolder target;

  @UiThread
  public WalletAdapter$MovieViewHolder_ViewBinding(WalletAdapter.MovieViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    WalletAdapter.MovieViewHolder target = this.target;
