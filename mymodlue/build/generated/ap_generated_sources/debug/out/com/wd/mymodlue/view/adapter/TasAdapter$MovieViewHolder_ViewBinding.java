...
public class TasAdapter$MovieViewHolder_ViewBinding implements Unbinder {
  private TasAdapter.MovieViewHolder target;

  @UiThread
  public TasAdapter$MovieViewHolder_ViewBinding(TasAdapter.MovieViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TasAdapter.MovieViewHolder target = this.target;
