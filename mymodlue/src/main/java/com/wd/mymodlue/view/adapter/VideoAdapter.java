 ...
 * function:
 */
public class VideoAdapter extends XRecyclerView.Adapter<VideoAdapter.MovieViewHolder> {
    List<VideoCollectBean.ResultBean> result;


    public VideoAdapter(List<VideoCollectBean.ResultBean> result) {
        this.result = result;
    }
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder movieViewHolder, final int i) {
        movieViewHolder.IjkView.setUrl(result.get(i).shearUrl);
        ...
        movieViewHolder.textBuyNum.setText(result.get(i).buyNum+"已经购买");
