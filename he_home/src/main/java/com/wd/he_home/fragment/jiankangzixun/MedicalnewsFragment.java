...
/**
 *@describe(描述)：MedicalnewsFragment   医学动态
 *@data（日期）: 2019/12/14
 *@time（时间）: 10:53
 *@author（作者）: Liuhe
 **/
public class MedicalnewsFragment extends BaseFragment<HomePresenter> implements HomeContract.HomeView {
    @Override
    protected int bindLayout() {
        return R.layout.medicalnewr_layout;
    }
