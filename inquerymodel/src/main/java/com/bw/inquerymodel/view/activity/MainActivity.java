...
public class MainActivity extends BaseActivity<IPresenter> implements DocTorContract.IMainView {
    ...
    protected void initView() {
        ...
        doctor_simple.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent ( MainActivity.this, InqueryActivity.class );
                intent.putExtra ( "doctorId",String.valueOf ( doctorId ) );
                startActivity ( intent );
            }
        } );

//        <!--            android:src="@mipmap/common_button_sequence_n"-->
//<!--            android:src="@mipmap/common_button_descending_s"-->
//<!--            android:src="@mipmap/common_button_ascending_s"-->
    }
